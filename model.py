...
class SqueezeExcitation(nn.Module):
    """
    Advanced Feature Attention Block (Inspired by DeepMVD/TAWFN).
    It allows the network to dynamically upweight/downweight features 
    for each specific protein sample.
    """
...
class ProteinDNN(nn.Module):
    ...
    def _init_weights(self):
        """
        Applies Kaiming (He) initialization to the linear layers.
        This prevents vanishing/exploding gradients during training.
        """
