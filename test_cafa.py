...
class CAFA_Evaluator_Bridge:
    ...
    def run_evaluation(self):
        ...
        print('Calculating metrics using CAFA-evaluator-PK')
        ...
        try:
            ...
            if dfs_best:
                ...
                try:
                    ...
                    print(f'Could not extract RU-MI curve data: {e_curve}')

                print('Saving run summary to experiment_log.csv')
                ...
                try:
                    ...
                    print(f'Could not read history.csv for logging: {e}')
                ...
                print('Evaluation completed but returned no best scores.')
        except Exception as e:
